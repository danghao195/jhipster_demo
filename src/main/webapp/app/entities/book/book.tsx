...
export class Book extends React.Component<IBookProps, IBookState> {
  ...
  render() {
    ...
    return (
      <div>
        <h2 id="book-heading">
          <Translate contentKey="jhipsterDemoApp.book.home.title">Books</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="jhipsterDemoApp.book.home.createLabel">Create new Book</Translate>
          </Link>
        </h2>
            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={this.sort('name')}>
                  <Translate contentKey="jhipsterDemoApp.book.name">Name</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={this.sort('author')}>
                  <Translate contentKey="jhipsterDemoApp.book.author">Author</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
