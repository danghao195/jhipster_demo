    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="jhipsterDemoApp.book.home.createOrEditLabel">
              <Translate contentKey="jhipsterDemoApp.book.home.createOrEditLabel">Create or edit a Book</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
              ...
              <AvForm model={isNew ? {} : bookEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  <Label id="nameLabel" for="name">
                    <Translate contentKey="jhipsterDemoApp.book.name">Name</Translate>
                  </Label>
                  <AvField id="book-name" type="text" name="name" />
                </AvGroup>
                <AvGroup>
                  <Label id="authorLabel" for="author">
                    <Translate contentKey="jhipsterDemoApp.book.author">Author</Translate>
                  </Label>
